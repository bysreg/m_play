...
(function() {
	...
	var PhoneInteraction = function(page) {
		...
		this._syllabus = page.createImage("/static/gnovel/res/textures/inGame_Syllabus.png", new THREE.Vector3(0, -20, this._z + 20), 1920 / 2, 1080 / 2);
		this._syllabus.material.opacity = 0;
		this._bgCover = page.createImage("/static/gnovel/res/textures/ui/BG_filter_syllabus.png", new THREE.Vector3(0, -20, this._z + 16), 1320, 840);
