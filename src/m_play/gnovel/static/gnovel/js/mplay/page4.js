...
(function() {
	...
	Page4.prototype = Object.create(GNOVEL.Page.prototype);
	Page4.prototype.constructor = Page4;

	/**
	 * @override
	 */
	Page4.prototype._onLoad = function() {
	...
	Page4.prototype._onNext = function() {
		this._state++;
		this._runAnim();
	};

	Page4.prototype._jump = function(index) {
		this._state = index - 1;
		this._onNext();
	};

	Page4.prototype._createFlowElements = function() {
		var o = [
	 ...
	 * @override
	 */
	Page4.prototype._onMouseDown = function(event) {
