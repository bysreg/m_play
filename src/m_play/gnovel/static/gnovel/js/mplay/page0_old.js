		...
		o = [
			...
			{type: "phone_textbox",
				...
				{type: "phone_textbox",
					...
					dontShowBg: true,
					charLine: 40,
					text: "Subject: Congratulations, You're Hired",
					messageAlign: "left",
					waitUntilShown: false,
					},
				{type: "phone_textbox",
					...
					charLine: 37,
					dontShowBg: true,
					text: "Dear " + player + ", Glad you'll be joining us at TechFast.  Ryan was right - you'll make a great addition to the team.  We'll be in touch. -J. WANG",
				bgHeight: 200},
