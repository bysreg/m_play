...
(function() {
	...
	Page0.prototype._onNext = function() {
		this._state++;
		this._runAnim();
	};

	Page0.prototype._showDialog = function(message, x, y, z, params) {
	...
	Page0.prototype._jump = function(index) {
		this._state = index - 1;
		this._onNext();
	}
	...
	Page0.prototype._moveLocation = function(index) {
		//this._state = index-1;
	 ...
	 * @override
	 */
	Page0.prototype._onMouseDown = function(event) {
