...
(function() {
	...
	MPlayPage.prototype._initChars = function() {
		...
		MPlayPage._ryan.setExpression("sad", this.createImage("/static/gnovel/res/textures/char/sad ryan.png", new THREE.Vector3(0, -210, this._characterLayer), 641, 1400), "Ryan");
