...
(function() {
	...
	Page5_0.prototype._onLoad = function() {
		...
		this.nextPageMaterialPath = "/static/gnovel/res/textures/backgrounds/classroom background_full.png";
	...
	Page5_0.prototype._createFlowElements = function() {
		...
		o = [
			{type: "show_context", text:"A few weeks later, and your group project deadline approaches."},
